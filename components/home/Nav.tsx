    ...
    <Box bg={"#1a1d24"} position="fixed" zIndex={100} width="100%">
      <Container maxW={1300}>
        <Flex
          ...
          color="white"
        >
          <Link href="/" pt={4} width={"200px"} height={"73px"}>
            <Image src="/logo.png" alt="logo of genai" />
          </Link>
          ...
          >
            <Link _hover={{ color: "#18DAFF", textDecoration: "none" }}>
              <Text>Home</Text>
            </Link>
            <Link _hover={{ color: "#18DAFF", textDecoration: "none" }}>
              <Text>Use cases</Text>
            ...
            <Link href="/dashboard">
              <Button
                p={6}
                _hover={{ bgColor: "#18DAFF", color: "black" }}
                border={"2px solid #18DAFF"}
                bgColor={"transparent"}
              >
                Try for free
              </Button>
